 ...
 * @author ramukunireddy
 *
 */
public class PropertiesHandler {
    private static final String properties = "selector.properties";
    private static final Properties selectorProp = new Properties();
    private static final InputStream in = WebDriverFactory.class.getResourceAsStream("/selectors/selector.properties");
